...
gl_questions_answers = {
    ...
    DORM_SHORT[V_RUSSIAN].lower() + ' №1': '管理局:\n'
                                           '•	dorm1@spbstu.ru\n'
                                           '•	+7 (812) 775 05 30 #1444\n'
                                           '•	+7 (812) 775 05 30 #1445\n'
                                           '•	森林大街, 街道号: 65, 楼号:1\n'
